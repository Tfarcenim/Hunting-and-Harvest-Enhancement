...
public class ModBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void registerTags() {
        getOrCreateBuilder(BlockTags.LEAVES).add(ModBlocks.ORANGE_LEAVES,ModBlocks.PALM_LEAVES,ModBlocks.BANANA_LEAVES);
        getOrCreateBuilder(BlockTags.LOGS_THAT_BURN).add(ModBlocks.ORANGE_LOG,ModBlocks.PALM_LOG,ModBlocks.BANANA_LOG);
    }
}
